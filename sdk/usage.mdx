...
[Evaluations](/concepts/product/evaluation) are created implicitly when you run [evaluation tasks](/concepts/product/evaluation/task) to assess the performance of a [product](/concepts/product) [version](/concepts/product/version) against [test cases](/concepts/product/test/case) using specific [metric types](/concepts/metric-type).
...
Once the [evaluation tasks](/concepts/product/evaluation/task) are completed, you can retrieve them to analyze the results.

```python
# Retrieve evaluation tasks for a specific version
