---
title: 'SDK Overview'
description: 'Overview of the Galtea Python SDK'
---

## Galtea Python SDK

The Galtea Python SDK allows ML engineers, AI researchers, and data scientists to interact with the Galtea platform programmatically. It provides functionalities to register products, create tests, perform evaluations, and more.
