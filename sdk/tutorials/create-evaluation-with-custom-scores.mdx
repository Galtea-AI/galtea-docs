...
galtea.metrics.create(name=accuracy_metric.name, source='self_hosted', description='checks for the presence of the keyword "correct" in the output')

# Your product's response
actual_output = "This response contains the correct keyword."

# 3. Run evaluation with your custom metric
