...
<ResponseField name="source" type="string" optional>
  The source of the metric. Possible values are:
  - `full_prompt`: /concepts/metric#creating-custom-metrics-via-full-prompt-llm
  - `partial_prompt`: /concepts/metric#creating-custom-metrics-via-partial-prompt-llm
  - `self_hosted`: /concepts/metric#self-hosted
