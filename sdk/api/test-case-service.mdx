...
```python
test_case = galtea.tests_cases.create(
    test_id="YOUR_TEST_ID",
    input="What is the capita of France?",
    expected_outpu="Paris",
...
```python
tests = galtea.tests.list(test_id="YOUR_TEST_ID")
```
<ResponseField name="test_id" type="string" required>
...
```python
test_case = galtea.tests.get(test_case_id="YOUR_TEST_ID")
```
...
```python
galtea.tests.delete(test_case_id="YOUR_TEST_ID")
```
