...
<ResponseField name="tag" type="string">
  An optional tag to categorize or label the test case (e.g., "general_knowledge", "edge_cases", "customer_query"). This helps in organizing and filtering test cases.
</ResponseField>
