...
This method evaluates an entire conversation stored in a [Session](/concepts/product/session) by creating evaluation tasks for each of its [Inference Results](//concepts/product/inference-result).
