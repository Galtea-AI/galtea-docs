...
This method evaluates an entire conversation stored in a [Session](/concepts/session) by creating evaluation tasks for each of its [Inference Results](/concepts/inference-result).
