...
<ResponseField name="evaluation_parameters" type="list[string]">
  The evaluation parameters for the metric. possible values are:
  ...
  <Note>
    Available parameters that can be referenced in your evaluation criteria or steps to perform consistent assessments. Each parameter represents a specific component of the evaluation process that will be analyzed during metric calculation.
    If not provided, only "input" will be used.
  </Note>
</ResponseField>
