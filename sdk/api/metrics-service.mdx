...
<ResponseField name="evaluation_parameters" type="list[string]">
  ...
  <Warning>
    ...
    You may refer to some parameters by other descriptive names like 'response' instead of 'actual output' and that is ok but you also need to include actual output to the evaluation_params list.
  </Warning>
</ResponseField>
