...
**Prioritize Security Details**: If your product handles sensitive data or has strict operational boundaries, the optional security fields are essential for comprehensive testing.
...
- **Skipping Security Context:** For security-sensitive applications, omitting boundaries can result in ineffective red teaming tests
