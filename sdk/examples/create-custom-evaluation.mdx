...
for test_case in test_cases:
    ...
    galtea.evaluation_tasks.create(
        ...
        score=get_score_for_custom_metric(response.output), # local function that will get a score between 0.0 and 1.0 based on the response of the LLM and your definition of the metric. 
