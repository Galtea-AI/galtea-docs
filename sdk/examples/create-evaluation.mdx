...
If you are using a custom test file that does not follow the test cases formats, you can load the test cases from the file and process them in a similar way:
