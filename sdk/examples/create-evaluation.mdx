...
If you want to fully customize the Evaluation Task, maybe because you are using a custom test file that does not follow the test cases formats, you can load the test cases from the file and set them in the evaluation task in a similar way:
