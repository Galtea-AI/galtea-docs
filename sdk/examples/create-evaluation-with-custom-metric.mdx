...
For now, you can only run a evaluation_task with the a single custom_metric at a time, so be careful with doing evaluations in batch with custom metrics.
...
for test_case in test_cases:
    ...
    galtea.evaluation_tasks.create(
        ...
        # Your function to get a score between 0.0 and 1.0 based on your criteria. 
        score=get_score_for_custom_metric(response.output),
        #################################################################
