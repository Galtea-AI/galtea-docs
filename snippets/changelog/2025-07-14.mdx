...
We've expanded our RAG metrics with **[Resilience To Noise](/concepts/metric/resilience-to-noise)**. This metric evaluates your product's ability to maintain accuracy and coherence when faced with "noisy" input, such as:
- Typographical errors
- OCR/ASR mistakes
- Grammatical errors
- Irrelevant or distracting content

This is essential for ensuring your AI performs reliably in real-world scenarios where user input isn't always perfect. [Learn more about how it's calculated](/concepts/metric/resilience-to-noise).
