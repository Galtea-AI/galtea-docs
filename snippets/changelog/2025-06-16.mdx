...
- **Reorganized [Version](/concepts/product/version), [Test](/concepts/product/test), and [Evaluation Task](/concepts/product/version/session/evaluation/task) Views:**  
...
- **[Evaluations](/concepts/product/version/session/evaluation) Visualization Removed:**  
...
- **Repurposed [evaluation_tasks.create()](/sdk/api/evaluation-task/create):**  
...
- **New [evaluation_tasks.create_single_turn()](/sdk/api/evaluation-task/create-single-turn) Method:**  
