...
You can now [evaluate conversations](/sdk/tutorials/monitor-production-responses-to-user-queries#evaluating-conversations) using these new metrics:
...
<Frame>
    <img src="/images/changelog/2025-05-12_improved_threat_selection.png" alt="Improved Threat Selection" />
</Frame>
