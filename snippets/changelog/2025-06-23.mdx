...
[Metrics](/concepts/metric) now support **tags** for easier classification and discovery. Quickly find and organize metrics relevant to your projects. [See all metrics](/concepts/metric).
