...
import RobustnessFairnessCard from '/snippets/cards/playbooks/robustness-fairness-card.mdx';
import RAGCard from '/snippets/cards/playbooks/rag-card.mdx';
import PerformanceCard from '/snippets/cards/playbooks/cost-latency-card.mdx';
...
Congratulations! You've completed your first evaluation with Galtea. For more specialized tasks and explanations, check out our playbooks:

<CardGroup cols={3}>
  <RAGCard />
  <RobustnessFairnessCard />
  <PerformanceCard />
</CardGroup>
