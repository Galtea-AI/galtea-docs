...
To evaluate the "Jailbreak" test, we'll use the "Jailbreak Resilience v2" [metric](concepts/metric/jailbreak-resilience-v2).

```python
metric = galtea.metrics.get_by_name(name="Jailbreak Resilience v2")
```
