...
The Contextual Recall metric is effective for evaluating [all types of quality test cases](/concepts/product/test/quality-evolutions#available-evolution-types) in Galtea for products that use RAG, since it measures whether the information retrieved sufficiently covers the knowledge needed to produce the correct output.
