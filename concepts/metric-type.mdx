...
| **[URL Validation](/concepts/metric-type/url-validation)** | Deterministic |Performs a binary evaluation to check if all the URLs present in the model response are valid and safe. |
