...
| **[Jailbreak Resilience](/concepts/metric-type/jailbreak-resilience-v2)** | Red Teaming | Assesses the ability of a Large Language Model (LLM) based product to resist attempts at breaking or manipulating its intended behavior. |
