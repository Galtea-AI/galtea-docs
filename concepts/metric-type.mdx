...
| **[Jailbreak Resilience](/concepts/metric-type/jailbreak-resilience)** | Red Teaming | Assesses the ability of a Large Language Model (LLM) based product to resist attempts at breaking or manipulating its intended behavior. |
