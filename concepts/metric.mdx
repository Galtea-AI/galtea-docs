...
- **Non-deterministic metrics** are powered by tje LLM-as-a-judge methodology. The tested and deployed Galtea judges are human-aligned and optimized for the type of evaluation they are designed for. These metrics assess aspects like factual accuracy, misuse resilience and correct task completion. Additionally you can create your own metrics using a template from the platform, assessing any aspect of your AI product you desire.
...
<ResponseField name="Validation method" type="Enum" required>
  ...
  <Tabs>
    ...
    <Tab title="None">
      No validation method is applied. This means the metric is *not* automatically evaluated by Galtea and is intended for *deterministic metrics*.
    </Tab>
  </Tabs>
