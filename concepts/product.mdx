...
<ResponseField name="Product Description" type="Text" required>
  ...
  **Example**: "An AI tool that generates concise summaries of legal documents while preserving key information."
    <Info>Learn how to write effective product descriptions in our [detailed guide](/sdk/tutorials/create-product-description).</Info>
</ResponseField>

<ResponseField name="Capabilities" type="Text" optional>
  The main capabilities and functions your product is designed to perform. 
</ResponseField>

<ResponseField name="Inabilities" type="Text" optional>
  The main limitations or technical constraints of your product.
</ResponseField>

<ResponseField name="Security Boundaries" type="Text" optional>
  Describe the security boundaries and restrictions that your product must enforce. Include data access limitations, behavioral constraints, and any security policies that must be maintained.
</ResponseField>
