...
The **Contextual Recall** metric evaluates whether the information retrieved by your RAG pipeline sufficiently covers the knowledge needed to produce the correct or expected output. It measures completeness rather than ranking.
...
$$
\text{Contextual Recall} = \frac{\text{Number of required facts present in retrieval context}}{\text{Total number of required facts}}
$$
