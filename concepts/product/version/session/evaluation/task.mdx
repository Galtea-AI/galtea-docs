...
<Steps>
  <Step title="Creation">[Trigger an evaluation task](/sdk/examples/create-evaluation). It will appear in the [Evaluation's](/concepts/product/version/session/evaluation) details page with the status "pending"</Step>
