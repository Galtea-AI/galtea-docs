...
You can run simulations programmatically using the Galtea SDK. Each simulation is guided by a [Scenario](/concepts/product/test/scenario-tests) attached to a [Test Case](/concepts/product/test/case).
...
Use the Galtea SDK to [automate conversation simulations](/sdk/api/simulator/service) and integrate them into your testing pipelines.

---

## See Also

- [Scenarios](/concepts/product/test/scenario-tests)
- [Test Cases](/concepts/product/test/case)
- [Simulate Conversation (SDK)](/sdk/api/simulator/service)