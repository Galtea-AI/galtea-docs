  ...
  <Accordion title="Technical Product Specifications">
    <Tabs>
      <Tab title="Raw CSV">
        ```csv
        ,instance_id,input,expected_output,tag,context
        0,0,"¿Cuál es el sistema operativo del Samsung Galaxy A8 EE?","El sistema operativo del Samsung Galaxy A8 EE es Android 8.1.","original","Noviembre 2018Catálogo \ndispositivos \nmóviles\nSamsung Galaxy A8 EE\n€/mes*11,49 Sistema Operativo : Android 8.1 + EMUI 8.1\nPantalla : 6.1\" OLED Full View Resolución Full HD..."
        1,1,"¿Cuántos megapíxeles tiene la cámara principal del Huawei P20?","La cámara principal del Huawei P20 tiene 20 MP + 12 MP.","original","Huawei P20\nSistema Operativo : Android 8.1 + \nEMUI 8.1\nPantalla : 5.8\" Full View Resolución \nFull HD (2244x1080p)\nCámara: 20 MP + 12MP FL8+ fl6. \nProcesador: Kirin 970 + IA (4x2,36 \n+ 4x1,8 GHz )"
        ```
      </Tab>
      <Tab title="Table View">
        | # | Instance ID | Input | Expected Output | Tag | Context |
        |---|------------|-------|-----------------|-----|---------|
        | 0 | 0 | ¿Cuál es el sistema operativo del Samsung Galaxy A8 EE? | El sistema operativo del Samsung Galaxy A8 EE es Android 8.1. | original | Noviembre 2018Catálogo dispositivos móviles Samsung Galaxy A8 EE €/mes*11,49 Sistema Operativo : Android 8.1 + EMUI 8.1 Pantalla : 6.1" OLED Full View Resolución Full HD... |
        | 1 | 1 | ¿Cuántos megapíxeles tiene la cámara principal del Huawei P20? | La cámara principal del Huawei P20 tiene 20 MP + 12 MP. | original | Huawei P20 Sistema Operativo : Android 8.1 + EMUI 8.1 Pantalla : 5.8" Full View Resolución Full HD (2244x1080p) Cámara: 20 MP + 12MP FL8+ fl6. Procesador: Kirin 970 + IA (4x2,36 + 4x1,8 GHz ) |
      </Tab>
    </Tabs>
  </Accordion>
