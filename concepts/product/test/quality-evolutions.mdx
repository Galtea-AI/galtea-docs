---
title: "Understanding Quality Test Variants"
description: "How the 'variants' parameter enhances test coverage and robustness in Galtea Quality Tests."
icon: ""
---

## Understanding Quality Test Variants
...
- **paraphrased**: Generates questions that are rephrased versions of the original, testing the model's ability to understand different phrasings.
- **typos**: Introduces common typographical errors into the questions, assessing the model's resilience to user mistakes.
- **incorrect**: Generates questions that might be subtly incorrect or misleading based on the context, challenging the model's precision.
- **cognitively_diverse**: Creates questions that require different cognitive approaches or levels of understanding, ensuring the model can handle a range of reasoning tasks.
- **linguistic_diverse**: Produces questions with varied linguistic structures or vocabulary, testing the model's flexibility with language.

These variants help assess your product's understanding and resilience by simulating real-world user behavior and edge cases. For more details on configuring variants, see the [Test Creation API documentation](/sdk/api/test/create).

---
title: "Evolve your Quality Tests"
description: "In order to test diverse user behaviour, Galtea provides diverse evolutions of base test cases"
icon: ""
---
