---
title: "Scenarios Tests"
description: "Evaluate multi-turn dialogue interactions using conversation simulation with synthetic users"
icon: "user-group"
iconType: "solid"
---

## What are Scenarios Tests?

Scenarios tests in Galtea are designed to evaluate the conversational capabilities of your [product](/concepts/product) through multi-turn dialogue interactions. These tests use the [Conversation Simulator](/concepts/conversation-simulator) to create realistic conversations with synthetic users that have specific goals, personalities, and behaviors.

Unlike [Quality Tests](/concepts/product/test/quality-tests) that focus on single-turn question-answer pairs, or [Red Teaming Tests](/concepts/product/test/red-teaming-tests) that test security vulnerabilities, Scenarios tests evaluate how well your AI product can:
...
## Creating Scenarios Tests

You can create scenarios tests in Galtea through two methods:

<Tabs>
  <Tab title="Generate from Context File">
    <Steps>
      <Step title="Prepare your context file">
        Create a file containing domain knowledge or context that will help generate realistic conversation scenarios (e.g., business processes, FAQ documents, service guidelines)
      </Step>
      <Step title="Configure the test">
        Select *Scenarios* as the test type and *Generated* as the test origin
        <Info>
      ...
      <Step title="Generate the test">
        Galtea will process the context file and generate conversation scenarios with different goals, user personas, and interaction patterns
      </Step>
    </Steps>
  </Tab>
...
Scenarios tests can cover various types of conversational interactions:
...
## Example Scenarios Tests and File Format

Here are examples of scenarios test content and structure:
...
<Note>
  This structure is required by Galtea to automatically generate the [test cases](/concepts/product/test/case) for your scenarios [test](/concepts/product/test). If this format is not provided, you can still [manually create the test cases](/sdk/api/test-case/service#create-test-case).
</Note>
...
## Structure of Scenarios Tests

Scenarios tests have a specific structure designed to enable realistic conversation simulation:
...
## Using Scenarios Tests with the Conversation Simulator

Scenarios tests are specifically designed to work with Galtea's [Conversation Simulator](/concepts/conversation-simulator). When you run evaluations using scenarios tests, the system will:
...
## Best Practices for Scenarios Tests
