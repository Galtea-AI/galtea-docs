...
Test cases are used with [evaluation tasks](/concepts/product/evaluation/task). You can run evaluation tasks directly using a `version_id`, and the appropriate [evaluation](/concepts/product/evaluation) will be automatically created.

<Card title="Run Evaluation Tasks" icon="badge-check" iconType="solid" href="/sdk/examples/create-evaluation">
  Learn how to run evaluation tasks with test cases
</Card>
...
<ResponseField name="Conversation Turns" type="List[Dict[Text, Text]]">
