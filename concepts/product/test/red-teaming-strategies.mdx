...
- **Roleplay**: Attempts to alter the model's identity, encouraging it to ignore its safety mechanisms to perform actions it would otherwise refuse by making the harmful request seem like part of a game or character's persona.
