...
[comment]: # (- **Biblical**: Frame prompts in the style of religious or biblical texts to mask intent. *May bypass filters looking for direct requests.*)
...
[comment]: # (- **Prefix**: Add benign or misleading prefixes to prompts to bypass safety mechanisms. *Distracts or misleads content filters.*)
[comment]: # (- **Math Prompt**: Express prompts using mathematical notation or equations to obfuscate meaning. *Can hide intent from standard text analysis.*)
...
[comment]: # (- **Roleplay**: Frame prompts as roleplay scenarios to encourage unintended model behavior by making the harmful request seem like part of a game or character's persona.)
