...
<Note> **Roleplay, Persuasive Content, Creative Writing, Data Analysis, Bait and Switch, and Empathetic Framing** use the **Product Description** to further customize the transformation of the original attack.</Note>
