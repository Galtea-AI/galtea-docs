...
<ResponseField name="Model ID" type="ID (text)">
  The ID of a [Model](/concepts/model) registered in Galtea. This is used for cost tracking and associating the version with a specific LLM's pricing and tokenization characteristics.
