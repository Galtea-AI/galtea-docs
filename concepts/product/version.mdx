...
<Card title="Run a Comparison Evaluation" icon="clipboard-check" iconType="solid" href="/concepts/product/version/session/evaluation">
...
<ResponseField name="Model" type="Model" required>
  ...
  This is used to calculate the cost of the inference for the version during [evaluation tasks](/concepts/product/version/session/evaluation/task).
</ResponseField>
