...
<CardGroup cols={3}>
  ...
  <Card title="Scenarios Tests" icon="user-group" href="/concepts/product/test/scenarios-tests">
    Tests that use conversation simulation to evaluate multi-turn dialogue interactions with synthetic users
  </Card>
</CardGroup>
...
<ResponseField name="Type" type="Enum" required>
  ...
  - [Scenarios](/concepts/conversation-simulator): Tests that use conversation simulation to evaluate multi-turn dialogue interactions
</ResponseField>
