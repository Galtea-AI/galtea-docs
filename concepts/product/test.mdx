...
The [Test Cases](/concepts/product/test/case) of a Test are used in [evaluation tasks](/concepts/product/version/session/evaluation-task) to assess the performance of specific [versions](/concepts/product/version) of your product. These tasks are grouped within [sessions](/concepts/product/version/session).
...
<Card title="Using Tests in Evaluation Tasks" icon="badge-check" iconType="solid" href="/concepts/product/version/session/evaluation-task">
  Learn how to use tests with evaluation tasks
</Card>
