...
The Faithfulness metric is effective for evaluating [all types of quality test cases](/concepts/product/test/quality-evolutions#available-evolution-types) in Galtea, for products that use RAG, since it measures the model's ability to maintain alignment with retrieved context:
...
- [Contextual Recall](/concepts/metric-type/contextual-recall)